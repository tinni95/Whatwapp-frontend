...
export default function ClientTable({setId,page,token,setFalseAdmin}) {
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          ...
          <TableCell style={{color:"white"}} align="center"></TableCell>
            <TableCell style={{color:"white"}} align="center">E- mail</TableCell>
            <TableCell style={{color:"white"}} align="center">Username</TableCell>
            <TableCell style={{color:"white"}} align="center">OS Version</TableCell>
            <TableCell style={{color:"white"}} align="center">App Version</TableCell>
            <TableCell style={{color:"white"}} align="center">Status</TableCell>
            <TableCell style={{color:"white"}} align="center">Device Language</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.email}>
                   <TableCell align="center"> <Button variant="contained" 
                    onClick={()=> setId(row._id)} color="primary"  style={{margin:20}}  >
    Chat
    </Button></TableCell>
